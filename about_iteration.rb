...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject operation add the passed value the array on which it's called upon
  end
  ...
  # ANSWER: resolving File.open Operation result into a file object, does not
  # take each line to be yielded as in its above declaration.
